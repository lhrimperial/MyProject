package com.ifarm.wechat.news.service;

import com.handy.frame.util.JsonUtils;
import com.ifarm.wechat.base.define.MessageKey;
import com.ifarm.wechat.base.define.MsgKey;
import com.ifarm.wechat.base.entity.resp.text.ResTextMsg;
import com.ifarm.wechat.base.util.MessageUtil;
import com.ifarm.wechat.news.message.MsgDispatcher;
...
public class CoreService {
	...
	public static String handleMsg(HttpServletRequest request, ApplicationContext context){
        ...
        try {
			...
			logger.info(JsonUtils.toJson(requestMap));
			//记录消息日志
